      ...
      <div className="landing">
        <div className="landing-box">
          <div className="left-landing">
            ...
            >
              ...
              <div className="text-ani">
                {trail.map(({ x, height, ...rest }, index) => (
                  ...
                  >
                    <animated.div className="text-ani-inner">
                      {items[index]}
                    </animated.div>
                  </animated.div>
                ))}
            ...
            <p className="lead left feature-p">
              Experience the best remote learning environment now
            </p>
      ...
      <div className="">
            ...
            <div className="count">
              <div className="discount_percentage">
                ...
                <span className="cross">
                  {' '}
                  <img className="cross-pic" src={Cross} alt="" />
                </span>
              </div>
            </div>
          </Fade>
          <h1 className="feature-paragraph">
            remote learners around the world, from New York to Cebu.
          </h1>
        </div>
        ...
        <div className="card">
            ...
            >
              <Fade bottom duration={1000}>
                ...
                <div className="feature-p">
                  Learning with people who are self-motivated like you help you
                  build confidence
                </div>
              </Fade>
            </motion.div>
          ...
          <div className="feature-show">
            ...
            >
              <Fade bottom duration={1000}>
                <div className="feature-text feature-paragraph">
                  Improve Quickly
                </div>
                <div className="feature-p">
                  The best new way to learn things are fun and easy. Study
                  groups are tailored to help you efficiently.
                </div>
          ...
          <div className="feature-cards">
            ...
            >
              <Fade bottom duration={1000}>
                ...
                <div className="feature-p">
                  Schedule your study time with displine. This gives you fully
                  flexible opportunity of learning
                </div>
              </Fade>
            </motion.div>
          </div>
