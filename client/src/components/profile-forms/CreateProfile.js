...
const CreateProfile = ({ createProfile, history }) => {
    ...
    <form className="form" onSubmit={e => onSubmit(e)}>
      ...
      <div className="form-group">
        <TextField type="text" label="Skills" name="skills" value={skills} onChange={e => onChange(e)} required />
        <small className="form-text"
          >Please use comma separated values <br/>(eg.
      ...
      <Link className="btn btn-light my-1" style={{position:"relative"}} to="/dashboard">Go Back</Link>
      </div>
      </form>
      </section>
      </Fragment>
